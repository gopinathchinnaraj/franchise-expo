// src/app/register/forms/ExhibitorForm.tsx
"use client";
...
export default function ExhibitorForm() {
  ...
  const validate = () => {
    ...
    if (form.requestType === "Select Request Type") next.requestType = "Please select a request type";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Map formType based on chosen requestType: Sponsorship -> sponsor-registration (maps to SPONSOR), otherwise exhibitor-enquiry (maps to EXHIBITOR)
    const isSponsorship = form.requestType.toLowerCase().includes("sponsor");
    const formType = isSponsorship ? "sponsor-registration" : "exhibitor-enquiry";
    ...
    <div className="w-full bg-white rounded-2xl border border-gray-100 p-8 max-sm:p-6 shadow-sm">
      <div className="mb-6">
        <h3 className="font-display text-2xl font-bold text-[#011b2e]">
          Exhibitor & Sponsor Inquiry
        </h3>
        <p className="font-body text-xs text-[#666666] mt-1">
          Complete the inquiry form below to discuss opportunities at the Expo.
        </p>
      </div>
      ...
      {status === "success" ? (
        <div className="text-center py-12">
          ...
          <p className="font-display text-xl font-bold text-[#011b2e]">Inquiry Submitted</p>
          <p className="font-body text-sm text-[#666666] mt-2 leading-relaxed">
            Thank you! Your exhibitor/sponsor request has been submitted. A team member will contact you soon with options.
          </p>
        </div>
      ) : (
        <form onSubmit={handleSubmit} noValidate className="space-y-5">
          {/* Full Name */}
          <div>
            <label htmlFor="exhibitor-fullName" className={labelClass}>
              Full Name <span className="text-red-500">*</span>
            </label>
            <input
              id="exhibitor-fullName"
              name="fullName"
              type="text"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              <label htmlFor="exhibitor-jobTitle" className={labelClass}>
                Job Title <span className="text-red-500">*</span>
              </label>
              <input
                id="exhibitor-jobTitle"
                name="jobTitle"
                type="text"
                placeholder="e.g. VP, Franchising"
                value={form.jobTitle}
                onChange={handleChange}
            ...
            <div>
              <label htmlFor="exhibitor-companyName" className={labelClass}>
              ...
              <input
                ...
                name="companyName"
                type="text"
                placeholder="e.g. Brand Solutions"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              <label htmlFor="exhibitor-workEmail" className={labelClass}>
                Work Email <span className="text-red-500">*</span>
              </label>
              <input
                id="exhibitor-workEmail"
                name="workEmail"
                type="email"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div>
              <label htmlFor="exhibitor-industry" className={labelClass}>
                Industry
              </label>
              <select
          ...
          {/* Request Type */}
          <div>
            <label htmlFor="exhibitor-requestType" className={labelClass}>
              Request Type <span className="text-red-500">*</span>
            </label>
            <select
              id="exhibitor-requestType"
              name="requestType"
          ...
          {/* Message */}
          <div>
            <label htmlFor="exhibitor-message" className={labelClass}>
              Message
            </label>
            <textarea
              ...
              name="message"
              rows={4}
              placeholder="Tell us about your franchise concept and requirements..."
              value={form.message}
              onChange={handleChange}
