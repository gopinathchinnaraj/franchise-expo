// src/app/register/forms/VisitorForm.tsx
"use client";
...
export default function VisitorForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload = {
      ...
      message: `Industry: ${form.industry}. Message: ${form.message}`,
    ...
    <div className="w-full bg-white rounded-2xl border border-gray-100 p-8 max-sm:p-6 shadow-sm">
      <div className="mb-6">
        ...
        <p className="font-body text-xs text-[#666666] mt-1">
          Complete the registration below to get visitor credentials.
        </p>
      </div>
      ...
      {status === "success" ? (
        <div className="text-center py-12">
          ...
          <p className="font-body text-sm text-[#666666] mt-2 leading-relaxed">
            Your visitor registration has been successfully submitted. We will send updates to your work email.
          </p>
        </div>
      ) : (
        <form onSubmit={handleSubmit} noValidate className="space-y-5">
          {/* Full Name */}
          <div>
            <label htmlFor="visitor-fullName" className={labelClass}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              <label htmlFor="visitor-jobTitle" className={labelClass}>
            ...
            <div>
              <label htmlFor="visitor-companyName" className={labelClass}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              <label htmlFor="visitor-workEmail" className={labelClass}>
                Work Email <span className="text-red-500">*</span>
              </label>
              <input
                id="visitor-workEmail"
                name="workEmail"
                type="email"
            ...
            <div>
              <label htmlFor="visitor-phone" className={labelClass}>
                Phone Number
              </label>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              <label htmlFor="visitor-country" className={labelClass}>
            ...
            <div>
              <label htmlFor="visitor-industry" className={labelClass}>
                Industry
              </label>
              <select
                id="visitor-industry"
          ...
          {/* Message */}
          <div>
            <label htmlFor="visitor-message" className={labelClass}>
              Message
            </label>
            <textarea
              id="visitor-message"
